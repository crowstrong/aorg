        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "national_number",
                    models.CharField(
                        help_text='Введіть національний номер у форматі "00.00.00-000.00"',
                        max_length=15,
                        validators=[
                            django.core.validators.RegexValidator(
                                message='Національний номер повинен бути у форматі "00.00.00-000.00".',
                                regex="^\\d{2}\\.\\d{2}\\.\\d{2}-\\d{3}\\.\\d{2}$",
                            )
                        ],
                        verbose_name="Національний номер",
                    ),
                ),
                (
                    "gender",
